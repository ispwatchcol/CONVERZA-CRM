...
function openEdit(contact) {
    ...
    // '' y no null: un contacto sin teléfono pondría "null" en el input.
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-3 min-w-0">
                                            ...
                                            <p class="text-xs text-gray-500 truncate">
                                                <span v-if="c.sin_telefono" class="text-sky-600">
                                                    🔒 {{ c.wa_username ? '@' + c.wa_username : 'Número oculto' }}
                                                </span>
                                                <template v-else>{{ formatPhone(c.phone) }}</template>
                    ...
                    <div class="p-6">
                        ...
                        <div class="flex items-start gap-3 mb-4">
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <p v-if="!selectedContact.sin_telefono" class="text-sm text-gray-500 font-mono">{{ formatPhone(selectedContact.phone) }}</p>
                                <p v-else class="text-sm text-sky-600">
                                    🔒 {{ selectedContact.wa_username ? '@' + selectedContact.wa_username : 'Número oculto' }}
                                    <span class="block text-[10px] text-gray-400 font-normal">
                                        Ocultó su número en WhatsApp. Puedes pedírselo por el chat y guardarlo acá para cruzarlo con ISPWatch.
                                    </span>
                                </p>
                        ...
                        <form @submit.prevent="save" class="space-y-4">
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">
                                    Teléfono
                                    <span v-if="!editingContact?.sin_telefono" class="text-red-500">*</span>
                                    <span v-else class="text-xs font-normal text-gray-400">(opcional)</span>
                                </label>
                                ...
                                <p v-else-if="editingContact?.sin_telefono" class="text-[10px] text-sky-600 mt-1">
                                    Este cliente ocultó su número en WhatsApp. Puedes dejarlo vacío; si te lo da por el chat, guárdalo acá y se cruzará con ISPWatch.
                                </p>
